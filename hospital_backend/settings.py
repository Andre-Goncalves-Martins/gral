...
SECRET_KEY = 'django-insecure-r-%$p8_y!%u*2ecv=)qg3y2j$wq^absecu+7%(jm#!usysllpj'#os.environ.get('SECRET_KEY')
...
JWT_AUTH_REFRESH_COOKIE = 'Bearer-refresh'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'gral.suport@gmail.com'
EMAIL_HOST_PASSWORD = 'gral123456'
